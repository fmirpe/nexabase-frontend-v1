<template>
  ...
  >
    ...
    >
      <!-- Modal Header -->
      <div
        class="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4 sticky top-0 z-40"
      >
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <div
              class="w-10 h-10 bg-opacity-20 rounded-lg flex items-center justify-center"
            >
              <svg
            ...
            <div>
              ...
              <p class="text-blue-100 text-sm">
                {{
                  editingCollection
                    ? "Modifica tu collection existente"
                    : "Define el esquema de tu nueva collection"
                }}
              </p>
            </div>
          </div>
                  ...
                  <div class="space-y-4">
                    <div>
                      ...
                      <p class="text-xs text-gray-500 mt-2 flex items-center">
                        ...
                        Debe iniciar con letra, solo letras, números y guion
                        bajo
                      </p>
                    </div>
                  ...
                  <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <p class="text-xs text-gray-500 mt-2">
                        Separados por coma para mejorar el rendimiento de
                        consultas
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                      Define los campos que tendrán los registros de esta
                      collection
                    </p>
                  </div>
                  <button
                ...
                <div class="p-6">
                  ...
                  >
                    ...
                    <p class="text-gray-500 mb-4">
                      Agrega al menos un campo para definir la estructura de tu
                      collection
                    </p>
                    <button
                      @click="emit('add-field')"
                      ...
                      <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center space-x-3">
                          <div
                            ...
                            :class="getFieldTypeColor(field.type)"
                          >
                            <component
                          ...
                          <div>
                            ...
                            <div class="flex items-center space-x-4 mt-1">
                              <span
                                :class="getFieldTypeBadgeColor(field.type)"
              ...
              <div class="bg-white rounded-lg border border-gray-200">
                ...
                >
                  <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                      Conecta esta collection con otras collections
                    </p>
                  </div>
                  <button
                ...
                <div class="p-6">
                  ...
                  >
                    ...
                    <p class="text-gray-500 mb-4">
                      Las relaciones permiten conectar registros entre
                      diferentes collections
                    </p>
                  </div>
              ...
              <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="mt-6 p-4 bg-blue-50 rounded-lg">
                  ...
                  <ul class="text-sm text-blue-800 space-y-1">
                    <li>
                      <code class="bg-blue-100 px-1 rounded">public</code> -
                    ...
                    <li>
                      <code class="bg-blue-100 px-1 rounded">owner</code> - Solo
                      el propietario del registro
                    </li>
                    <li>
                      <code class="bg-blue-100 px-1 rounded">admin</code> - Solo
                      administradores
                    </li>
                    <li>
                      <code class="bg-blue-100 px-1 rounded">none</code> -
                      Acceso denegado
                    </li>
                  </ul>
                </div>
            ...
            <div v-if="activeTab === 'preview'" class="space-y-6">
              <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-6">
                  ...
                  <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <dd class="text-sm text-gray-900">
                          {{ form.metadata?.description || "Sin descripción" }}
                        </dd>
                      </div>
                      <div>
                        <dt class="text-sm font-medium text-gray-500">
                  ...
                  <div class="bg-gray-50 rounded-lg p-4">
                    <h4 class="font-medium text-gray-900 mb-4">
                      Relaciones ({{ relationList.length }})
                    </h4>
                    <div
                      v-if="relationList.length === 0"
                      class="text-center py-4 text-gray-500"
                    ...
                    <div v-else class="space-y-2">
                      ...
                      >
                        <div class="flex items-center space-x-3">
                          ...
                          <div>
                            <div class="font-medium text-gray-900">
                              {{ relation.field || "Sin nombre" }}
                            </div>
                            <div class="text-xs text-gray-500">
                              {{ relation.type }} → {{ relation.references }}
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <pre
                      class="bg-gray-900 text-green-400 p-4 rounded text-xs overflow-x-auto"
                      >{{ JSON.stringify(generatePreviewJSON(), null, 2) }}</pre
                    >
                  </div>
                </div>
              </div>
      ...
      <!-- Footer Actions -->
      <div
        class="bg-white px-6 py-4 border-t border-gray-200 flex items-center justify-between shadow-lg sticky bottom-0 z-50"
      >
        <div class="flex items-center space-x-4">
          ...
          >
            ...
            <span
              >{{ schemaFields.length }} campo{{
                schemaFields.length !== 1 ? "s" : ""
              }}</span
            >
            ...
            <span
              >{{ relationList.length }} relación{{
                relationList.length !== 1 ? "es" : ""
              }}</span
            >
          </div>
        </div>
...
function generatePreviewJSON() {
  ...
  return {
    ...
    auth_rules: {
      create: props.authCreateInput
        ? props.authCreateInput.split(",").map((s: string) => s.trim())
        : [],
      read: props.authReadInput
        ? props.authReadInput.split(",").map((s: string) => s.trim())
        : [],
      update: props.authUpdateInput
        ? props.authUpdateInput.split(",").map((s: string) => s.trim())
        : [],
      delete: props.authDeleteInput
        ? props.authDeleteInput.split(",").map((s: string) => s.trim())
        : [],
    },
    metadata: {
