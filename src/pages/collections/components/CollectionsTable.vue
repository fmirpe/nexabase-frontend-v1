            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                ...
                <div class="ml-4 flex items-center space-x-2">
                  ...
                  <span
                    v-if="collection.is_view"
                    class="text-xs font-semibold text-indigo-600 bg-indigo-100 rounded-full px-2 py-0.5"
                  >
                    Vista
                  </span>
                </div>
              </div>
              <div v-if="collection.metadata?.description" class="text-sm text-gray-500 mt-1">
