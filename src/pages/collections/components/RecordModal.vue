    ...
    >
        ...
        <div class="w-80 bg-gray-50 border-r border-gray-200 flex flex-col">
          <div class="p-4 border-b border-gray-200 flex-shrink-0">
            ...
            <div class="grid grid-cols-3 gap-2 text-xs text-center mb-4">
              ...
              <div
                class="bg-blue-50 rounded-lg p-2 border border-blue-200"
                v-else
              >
          ...
          <div class="flex-1 overflow-y-auto p-4">
            <div class="space-y-2">
              ...
              >
                ...
                <div
                  ...
                  :class="getFieldTypeColor(fieldDef.type)"
                >
                  <component
                    :is="getFieldTypeIcon(fieldDef.type)"
                    class="w-5 h-5"
                  />
                </div>
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center space-x-1 mt-1">
                    <span
                      ...
                      class="inline-flex px-1.5 py-0.5 text-xs font-medium bg-red-100 text-red-600 rounded"
                    >
                      req
                    </span>
                    <span
                      v-if="fieldDef.unique"
                      class="inline-flex px-1.5 py-0.5 text-xs font-medium bg-purple-100 text-purple-600 rounded"
                    >
                      único
                    </span>
                    <span
            ...
            <div
              v-if="
                ...
                Object.keys(collection.schema.fields).length === 0
              "
            ...
            <div class="max-w-3xl mx-auto space-y-6">
              ...
              >
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <div>
                      <label class="text-lg font-semibold text-gray-900">
                        {{ fieldName }}
                        <span v-if="fieldDef.required" class="text-red-500 ml-1"
                          >*</span
                        >
                      </label>
                      <div class="flex items-center space-x-2 mt-1">
                        <span
                          ...
                          :class="getFieldTypeBadgeColor(fieldDef.type)"
                        >
                          {{ fieldDef.type }}
                        </span>
                        <span
                ...
                <div class="space-y-4">
                  ...
                  <template
                    v-else-if="
                      ['string', 'email', 'url'].includes(fieldDef.type)
                    "
                  >
                    <div class="relative">
                      <input
                    ...
                    <div class="space-y-3">
                      <div class="relative">
                        ...
                        <div class="absolute top-3 right-3">
                          ...
                          <span
                            v-else
                            class="inline-flex items-center px-2 py-1 text-xs bg-red-100 text-red-800 rounded-full"
                          >
                            <svg
                              class="w-3 h-3 mr-1"
                              fill="currentColor"
                  ...
                  <!-- Field Help Text -->
                  <div
                    v-if="getFieldHelpText(fieldDef)"
      ...
      >
        <div class="flex items-center space-x-4">
          ...
          <div
            class="hidden sm:flex items-center space-x-4 text-sm text-gray-500"
          >
        ...
        <div class="flex items-center space-x-3">
          ...
          <div
            v-if="!canSave"
            class="hidden sm:flex items-center space-x-2 text-sm text-red-600 bg-red-50 px-3 py-2 rounded-lg"
          >
...
const totalRequiredFields = computed(
  () =>
    Object.entries(props.collection?.schema?.fields || {}).filter(
      ([_, fieldDef]: [string, any]) => fieldDef.required
    ).length
);
...
const canSave = computed(() => {
  ...
  const requiredFieldsComplete = Object.entries(
    props.collection?.schema?.fields || {}
  ).every(([fieldName, fieldDef]: [string, any]) => {
    ...
    for (const [fieldName, relationConfig] of Object.entries(schemaRelations)) {
      ...
      if (config.type === "belongs_to") {
        ...
        try {
          ...
          console.error(
            `Error loading options for ${referencedCollection}:`,
            error
          );
...
function getFieldHelpText(fieldDef: any): string {
  ...
  if (fieldDef.default !== undefined)
    hints.push(`Por defecto: ${fieldDef.default}`);
